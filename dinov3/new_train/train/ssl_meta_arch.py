...
from dinov3.new_train.utils import empty_cache, get_device, log_last_row_stats
...
class SSLMetaArch(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        assert cfg.dtch.enabled is True
    ...
    def forward_backward(
        self, data, *, teacher_temp, iteration=0, logger_freq=0, **ignored_kwargs
        ...
        if self.has_gram_teacher:
            ...
            gram_teacher_crops = data["collated_gram_teacher_crops"].to(device=self.device, non_blocking=True)
        else:
    ...
    def get_teacher_output(
        ...
        *,
        ...
        masked_patch_centered = self.ibot_patch_loss.sinkhorn_knopp_teacher(
            ...
            iteration=it,
            logger_freq=logger_freq,
            logger_loss='ibot_patch_balance',
        )  # [n_masked_patches, K]
